...
public class IssueBookForm extends JFrame {
	...
	public IssueBookForm() { // construct
		...
		JButton btnIssueBook = new JButton("Issue Book"); // new btn
		...
		JLabel lblNewLabel_1 = new JLabel("Note: Please check Student ID Carefully before issuing book!"); // note
