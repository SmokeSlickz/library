...
public class BooksForm extends JFrame {
	...
	public BooksForm() { // construct
		...
		JLabel lblAddBooks = new JLabel("Add Books"); // header
		...
		textField_3 = new JTextField(); // publish
		textField_3.setColumns(10);

		textField_4 = new JTextField(); // quant str
		...
		btnAddBooks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int quantity = Integer.parseInt(squantity); // quant int
				int i = BookDao.save(callno, name, author, publisher, quantity); // db upd
		...
		JButton btnBack = new JButton("Back"); // prev
