...
public class DeleteLibrarian extends JFrame {
	...
	public DeleteLibrarian() { // construct
		...
		JButton btnDelete = new JButton("Delete"); // del btn
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (sid == null || sid.trim().equals("")) {
					...
					int i = LibrarianDao.delete(id); // db upd
					if (i > 0) {
		...
		JButton btnNewButton = new JButton("Back"); // prev
