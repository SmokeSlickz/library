...
public class AdminSuccess extends JFrame {
	...
	public AdminSuccess() { // construct
		...
		JLabel lblAdminSection = new JLabel("Admin Section"); // header
		lblAdminSection.setFont(new Font("Tahoma", Font.PLAIN, 22));
		lblAdminSection.setForeground(Color.GRAY);

		JButton btnNewButton = new JButton("Add Librarian"); // add lib btn
		...
		JButton btnViewLibrarian = new JButton("View Librarian"); // view lib btn
		...
		JButton btnDeleteLibrarian = new JButton("Delete Librarian"); // del lib btn
		...
		JButton btnLogout = new JButton("Logout"); // logout btn
